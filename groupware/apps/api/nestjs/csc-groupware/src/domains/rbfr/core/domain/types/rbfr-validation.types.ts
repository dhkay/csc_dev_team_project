/**
 * RBFR 처방 검증 도메인 타입. rbfr/개발지침/03 DB스키마.md의 rbfr_* 테이블과 대응(주석에 표기).
 * `/var/www/rbfr/engine/src/validationTypes.ts`(4단계 프로토타입)에서 이동.
 */

import type { FormulaIngredientInput } from './rbfr-scoring.types';
