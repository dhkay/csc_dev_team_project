...
import { ALL_PROVISIONING_MODES, ProvisioningMode } from '../../../../core/domain/types/entitlement-catalog';

/** AI 도구 카탈로그 수정 요청: 표시명/slug/프로비저닝(제공된 필드만). key/enum 고정 */
export class UpdateAiToolDto {
  @ApiPropertyOptional({ description: 'AI 도구 표시명', example: '마케팅 영상 제작', maxLength: 120 })
  @IsOptional()
  @IsString()
  @IsNotEmpty()
  @MaxLength(120)
