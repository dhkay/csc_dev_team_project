// 업로드할 이미지 파일의 허용 규칙: 여러 기능(프로필 이미지, 기획안 씬 이미지 등)이 공유한다.
// 순수 함수(네트워크 없음). 업로드 시퀀스는 $lib/infrastructure/http/upload 가 담당한다.
//
// 값은 file-upload 정책과 맞춘다(.claude/rules/file-upload-limits.md: 이미지 10MB, JPEG/PNG/GIF/WebP/SVG)
